...
using static WordWebCMS.Setting;
...
namespace WordWebCMS
{
    ...
    public class Users
    {
        ...
        => $"<aside id=\"widget-user\" class=\"widget widget-user\"><h2 class=\"widget-title\">Hi! {UserName}</h2><ul><a href=\"User.aspx\"><li><img width=\"80\" height=\"80\" " +
            $"class=\"user-avatar\" src={AvatarURL}></li></a><a href=\"User.aspx?action=exp\" class=\"aclear\"><li>Lv:{Lv} Exp:{Exp}/{Lv * 10}</li></a><a href=\"User.aspx?action=money\"><li>积分:{Money}</li></a><a href=\"User.aspx\"><li>->前往用户主页</li></a>" +
